...
class ArvoreTrie {
    ...
    public void criarLog(long tempoInicial, int comparacoes) {
        ...
        Arq.println("Matricula: 792421\t" + "Numero Comparacoes: " + comparacoes + "\t" + "Tempo Execucao: "
                + (tempoFinal - tempoInicial) + "ms");
        Arq.close();
    }
}

public class TP04Q08n {
    public static void main(String[] args) throws Exception {
        MyIO.setCharset("ISO-8859-1");
        long tempoInicial = System.currentTimeMillis(); 

        ArvoreTrie arvorePrimeiraPersonagens = new ArvoreTrie(); 
        ArvoreTrie arvoreSegundaPersonagens = new ArvoreTrie(); 
        ...
        arvoreMergePersonagens.criarLog(tempoInicial, totalComparacoes);
